...
export function showReportModal() {
    ...
    modal.innerHTML = `
            ...
            <button id="dismissButton" style="background-color: #ACE1F4; position: fixed; top: 88%; right: 50%; z-index: 1000; padding: 10px 20px; border: none; border-radius: 4px; cursor: pointer; transition: transform 0.1s, width 0.3s ease-in-out;">레포트 닫기</button>
        `;
